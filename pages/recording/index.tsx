...
import { Button, Form, FormControlProps, Stack } from "react-bootstrap";
          ...
          <Form onSubmit={handleUpload} className="col-md-12 col-lg-10 col-xl-8">
            ...
            <div className="gap-4 flex-wrap">
              <Form.Group controlId="description">
                ...
                <Form.Control onChange={(e) => setMaxChars(e.target.value.length)} as="textarea" rows={4} maxLength={255} placeholder="e.g. Mijn interview voor back-end web developer" required />
            ...
            <Button variant="light" className="mt-3 ms-2" onClick={handleBackClick}>Back</Button>
          </Form>
        </div>
      ) : (
        <div>
